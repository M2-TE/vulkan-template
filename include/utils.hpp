...
namespace utils {
    ...
    inline void transition_layout_rw(vk::raii::CommandBuffer& cmd, vk::Image& image, vk::ImageLayout layoutOld, vk::ImageLayout layoutNew) {
        vk::ImageMemoryBarrier2 imageBarrier = vk::ImageMemoryBarrier2()
            .setSrcStageMask(vk::PipelineStageFlagBits2::eAllCommands) // could be relaxed
            .setSrcAccessMask(vk::AccessFlagBits2::eMemoryRead)
            .setDstStageMask(vk::PipelineStageFlagBits2::eAllCommands) // could be relaxed
    ...
    inline void transition_layout_wr(vk::raii::CommandBuffer& cmd, vk::Image& image, vk::ImageLayout layoutOld, vk::ImageLayout layoutNew) {
        vk::ImageMemoryBarrier2 imageBarrier = vk::ImageMemoryBarrier2()
            .setSrcStageMask(vk::PipelineStageFlagBits2::eAllCommands) // could be relaxed
